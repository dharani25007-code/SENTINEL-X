        ...
        <div className="chart-card-elevated">
          <div className="chart-header">
            <div>
              ...
              <p>Top fatal hazard categories categorized under Report 459 taxonomy</p>
            </div>
          ...
          <div style={{ height: 280, width: '100%', marginTop: 16 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={ruleData} layout="vertical" margin={{ top: 5, right: 20, left: 10, bottom: 0 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#162932" horizontal={false} />
                <XAxis type="number" tick={{ fill: '#7E95A0', fontSize: 11, fontFamily: 'var(--font-mono)' }} axisLine={false} tickLine={false} />
                <YAxis type="category" dataKey="name" tick={{ fill: '#C5D6DF', fontSize: 11, fontWeight: 500 }} width={160} axisLine={false} tickLine={false} />
                <Tooltip
